...
```typescript
import { CharactersCharacterIdContractsContractIdItemsGetInner } from 'eve-esi-client-ts';

const instance: CharactersCharacterIdContractsContractIdItemsGetInner = {
    is_included,
    is_singleton,
    quantity,
    raw_quantity,
