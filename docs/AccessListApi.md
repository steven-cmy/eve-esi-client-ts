...
|------------- | ------------- | -------------|
|[**getCharactersAccessListsDetail**](#getcharactersaccesslistsdetail) | **GET** /characters/{character_id}/access-lists/{access_list_id} | Get Access List details|
|[**getCharactersAccessListsListing**](#getcharactersaccesslistslisting) | **GET** /characters/{character_id}/access-lists | List Access Lists|

# **getCharactersAccessListsDetail**
> CharactersAccessListsDetail getCharactersAccessListsDetail()
...
const { status, data } = await apiInstance.getCharactersAccessListsDetail(
    accessListId,
    characterId,
    xCompatibilityDate,
    acceptLanguage,
...
> CharactersAccessListsListing getCharactersAccessListsListing()
...
const { status, data } = await apiInstance.getCharactersAccessListsListing(
    characterId,
    xCompatibilityDate,
    acceptLanguage,
    ifNoneMatch,
