...
```typescript
import { CorporationsCorporationIdWalletsDivisionJournalGetInner } from 'eve-esi-client-ts';

const instance: CorporationsCorporationIdWalletsDivisionJournalGetInner = {
    amount,
    balance,
    context_id,
    context_id_type,
