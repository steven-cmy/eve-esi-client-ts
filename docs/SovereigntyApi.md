...
|[**getSovereigntySystems**](#getsovereigntysystems) | **GET** /sovereignty/systems | List sovereignty details for K-space systems|

# **getSovereigntyCampaigns**
> Array<SovereigntyCampaignsGetInner> getSovereigntyCampaigns()
...
**Array<SovereigntyCampaignsGetInner>**
...
> SovereigntySystems getSovereigntySystems()
...
const { status, data } = await apiInstance.getSovereigntySystems(
    xCompatibilityDate,
    acceptLanguage,
    ifNoneMatch,
    xTenant,
