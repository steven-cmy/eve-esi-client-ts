...
**allow_alliance_access** | **boolean** |  | [default to undefined]
**bad_standing_tax_rate** | **number** |  | [optional] [default to undefined]
**corporation_tax_rate** | **number** |  | [optional] [default to undefined]
...
**good_standing_tax_rate** | **number** |  | [optional] [default to undefined]
...
```typescript
import { CorporationsCorporationIdCustomsOfficesGetInner } from 'eve-esi-client-ts';

const instance: CorporationsCorporationIdCustomsOfficesGetInner = {
    alliance_tax_rate,
