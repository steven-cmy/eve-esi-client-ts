...
------------ | ------------- | ------------- | -------------
**attackers** | [**Array&lt;KillmailsKillmailIdKillmailHashGetAttackersInner&gt;**](KillmailsKillmailIdKillmailHashGetAttackersInner.md) |  | [default to undefined]
...
**victim** | [**KillmailsKillmailIdKillmailHashGetVictim**](KillmailsKillmailIdKillmailHashGetVictim.md) |  | [default to undefined]
**war_id** | **number** | War if the killmail is generated in relation to an official war  | [optional] [default to undefined]

## Example

```typescript
import { KillmailsKillmailIdKillmailHashGet } from 'eve-esi-client-ts';

const instance: KillmailsKillmailIdKillmailHashGet = {
    attackers,
    killmail_id,
    killmail_time,
    moon_id,
