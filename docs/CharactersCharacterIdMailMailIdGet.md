...
**labels** | **Set&lt;number&gt;** | Labels attached to the mail | [optional] [default to undefined]
...
```typescript
import { CharactersCharacterIdMailMailIdGet } from 'eve-esi-client-ts';

const instance: CharactersCharacterIdMailMailIdGet = {
    body,
    from,
    labels,
    read,
