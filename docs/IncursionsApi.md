...
|------------- | ------------- | -------------|
|[**getIncursions**](#getincursions) | **GET** /incursions | List incursions|

# **getIncursions**
> Array<IncursionsGetInner> getIncursions()
...
const { status, data } = await apiInstance.getIncursions(
    xCompatibilityDate,
    acceptLanguage,
    ifNoneMatch,
    xTenant,
