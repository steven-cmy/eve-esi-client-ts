...
**blueprint_id** | **number** |  | [default to undefined]
...
**blueprint_type_id** | **number** |  | [default to undefined]
...
```typescript
import { CorporationsCorporationIdIndustryJobsGetInner } from 'eve-esi-client-ts';

const instance: CorporationsCorporationIdIndustryJobsGetInner = {
    activity_id,
    blueprint_id,
