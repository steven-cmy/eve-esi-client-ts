...
------------ | ------------- | ------------- | -------------
**character_id** | **number** |  | [default to undefined]
**join_time** | **string** |  | [default to undefined]
...
```typescript
import { FleetsFleetIdMembersGetInner } from 'eve-esi-client-ts';

const instance: FleetsFleetIdMembersGetInner = {
    character_id,
    join_time,
    role,
    role_name,
