...
**participants** | [**Array&lt;SovereigntyCampaignsGetInnerParticipantsInner&gt;**](SovereigntyCampaignsGetInnerParticipantsInner.md) | Alliance participating and their respective scores, only present in Freeport Events.  | [optional] [default to undefined]
...
```typescript
import { SovereigntyCampaignsGetInner } from 'eve-esi-client-ts';

const instance: SovereigntyCampaignsGetInner = {
    attackers_score,
    campaign_id,
    constellation_id,
    defender_id,
