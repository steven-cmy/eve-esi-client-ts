...
**contract_id** | **number** |  | [default to undefined]
...
```typescript
import { CorporationsCorporationIdContractsGetInner } from 'eve-esi-client-ts';

const instance: CorporationsCorporationIdContractsGetInner = {
    acceptor_id,
    assignee_id,
    availability,
    buyout,
