...
```typescript
import { CorporationsStructuresSovereigntyHubsDetailTransportState } from 'eve-esi-client-ts';

const instance: CorporationsStructuresSovereigntyHubsDetailTransportState = {
    _import,
    _export,
    transit,
};
