...
------------ | ------------- | ------------- | -------------
**allow_alliance_members** | **boolean** |  | [default to undefined]
**allow_corporation_members** | **boolean** |  | [default to undefined]
**anchor** | **string** | Who can anchor starbase (POS) and its structures | [default to undefined]
**attack_if_at_war** | **boolean** |  | [default to undefined]
**attack_if_other_security_status_dropping** | **boolean** |  | [default to undefined]
...
**fuels** | [**Array&lt;CorporationsCorporationIdStarbasesStarbaseIdGetFuelsInner&gt;**](CorporationsCorporationIdStarbasesStarbaseIdGetFuelsInner.md) | Fuel blocks and other things that will be consumed when operating a starbase (POS) | [optional] [default to undefined]
...
```typescript
import { CorporationsCorporationIdStarbasesStarbaseIdGet } from 'eve-esi-client-ts';

const instance: CorporationsCorporationIdStarbasesStarbaseIdGet = {
