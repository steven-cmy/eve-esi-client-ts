...
|------------- | ------------- | -------------|
|[**getDogmaAttributes**](#getdogmaattributes) | **GET** /dogma/attributes/ | Get attributes|
|[**getDogmaAttributesAttributeId**](#getdogmaattributesattributeid) | **GET** /dogma/attributes/{attribute_id}/ | Get attribute information|
|[**getDogmaDynamicItemsTypeIdItemId**](#getdogmadynamicitemstypeiditemid) | **GET** /dogma/dynamic/items/{type_id}/{item_id}/ | Get dynamic item information|
|[**getDogmaEffects**](#getdogmaeffects) | **GET** /dogma/effects/ | Get effects|
|[**getDogmaEffectsEffectId**](#getdogmaeffectseffectid) | **GET** /dogma/effects/{effect_id}/ | Get effect information|

# **getDogmaAttributes**
> Array<number> getDogmaAttributes()
...
const { status, data } = await apiInstance.getDogmaAttributes(
    datasource,
    ifNoneMatch
);
```
...
let attributeId: number; //A dogma attribute ID (default to undefined)
let datasource: 'tranquility'; //The server name you would like data from (optional) (default to 'tranquility')
let ifNoneMatch: string; //ETag from a previous request. A 304 will be returned if this matches the current ETag (optional) (default to undefined)

const { status, data } = await apiInstance.getDogmaAttributesAttributeId(
    attributeId,
    datasource,
    ifNoneMatch
);
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **attributeId** | [**number**] | A dogma attribute ID | defaults to undefined|
| **datasource** | [**&#39;tranquility&#39;**]**Array<&#39;tranquility&#39;>** | The server name you would like data from | (optional) defaults to 'tranquility'|
| **ifNoneMatch** | [**string**] | ETag from a previous request. A 304 will be returned if this matches the current ETag | (optional) defaults to undefined|
...
let itemId: number; //item_id integer (default to undefined)
let typeId: number; //type_id integer (default to undefined)
let datasource: 'tranquility'; //The server name you would like data from (optional) (default to 'tranquility')
let ifNoneMatch: string; //ETag from a previous request. A 304 will be returned if this matches the current ETag (optional) (default to undefined)

const { status, data } = await apiInstance.getDogmaDynamicItemsTypeIdItemId(
    itemId,
    typeId,
    datasource,
    ifNoneMatch
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **itemId** | [**number**] | item_id integer | defaults to undefined|
| **typeId** | [**number**] | type_id integer | defaults to undefined|
| **datasource** | [**&#39;tranquility&#39;**]**Array<&#39;tranquility&#39;>** | The server name you would like data from | (optional) defaults to 'tranquility'|
| **ifNoneMatch** | [**string**] | ETag from a previous request. A 304 will be returned if this matches the current ETag | (optional) defaults to undefined|
...
const { status, data } = await apiInstance.getDogmaEffects(
    datasource,
    ifNoneMatch
);
```
...
> GetDogmaEffectsEffectIdOk getDogmaEffectsEffectId()
...
let effectId: number; //A dogma effect ID (default to undefined)
let datasource: 'tranquility'; //The server name you would like data from (optional) (default to 'tranquility')
let ifNoneMatch: string; //ETag from a previous request. A 304 will be returned if this matches the current ETag (optional) (default to undefined)

const { status, data } = await apiInstance.getDogmaEffectsEffectId(
    effectId,
    datasource,
    ifNoneMatch
);
...
|Name | Type | Description  | Notes|
|------------- | ------------- | ------------- | -------------|
| **effectId** | [**number**] | A dogma effect ID | defaults to undefined|
| **datasource** | [**&#39;tranquility&#39;**]**Array<&#39;tranquility&#39;>** | The server name you would like data from | (optional) defaults to 'tranquility'|
| **ifNoneMatch** | [**string**] | ETag from a previous request. A 304 will be returned if this matches the current ETag | (optional) defaults to undefined|
