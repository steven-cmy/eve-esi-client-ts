...
**services** | [**Array&lt;CorporationsCorporationIdStructuresGetInnerServicesInner&gt;**](CorporationsCorporationIdStructuresGetInnerServicesInner.md) | Contains a list of service upgrades, and their state | [optional] [default to undefined]
...
```typescript
import { CorporationsCorporationIdStructuresGetInner } from 'eve-esi-client-ts';

const instance: CorporationsCorporationIdStructuresGetInner = {
    corporation_id,
    fuel_expires,
    name,
